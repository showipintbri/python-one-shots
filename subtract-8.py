...
with open("test_css.html", "rt") as html:         # Open the file and read all the lines into a list.
  content = html.readlines()
 
for i in range(0,len(content)):                   # Itterate over the list.
  ...
  if x: 
    ...
    print(content[i].rstrip())                    # If no matches were found, print to stdout 
                                                  # so I can copy complete output from stdout
